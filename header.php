<div class="container-fluid row" style="padding: 0; margin: 0;">
            <div class="col-4 brand text-center">
                <a class="navbar-brand mr-auto" href="index.php"><img src="imagens/Header/LogoUmaLinhaColorVerdeB.jpeg" alt="" class="img-fluid"></a>
            </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">            
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                        <form class="form-inline" action="search.php" method="get">
                            <input class="form-control form-control-sm mr-sm-1" type="search" placeholder="Pesquisar..." name="pesquisar">
                      ...
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="wishlist.php"><img src="imagens/Header/heart.png" alt="" class="icone"></a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="#"><img src="imagens/Header/shopping-cart.png" alt="" class="icone"></a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" href="add-user-form.php"><img src="imagens/Header/user.png" alt="" class="icone"></a>
                          </li>                   
                       </ul>
                    </div>    
                </nav>
